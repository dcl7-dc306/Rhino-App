<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="pg_single.aspx.cs" Inherits="Rhino_App.single" %>
...
<asp:Content ID="content" ContentPlaceHolderID="content" runat="server">
	...
	<section class="section-content bg padding-y-sm u-margin-top-huge u-padding-top-medium">
		<div class="container">
			<%--<nav class="mb-3">
				<ol class="breadcrumb">
